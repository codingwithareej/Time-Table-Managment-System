...
$sql = "select subject_name ,starting_time ,ending_time ,fri_starting_time,fri_ending_time ,room_no , teacher_name from timetable_intermediate t1 INNER JOIN intermediate_subject t2 on t1.subject_id=t2.subject_id INNER JOIN timetable t3 on t1.id=t3.id WHERE t1.class='ICS' AND t1.part='part-I'";
...
//FSC pre-Engeneering
$sql = "select subject_name ,starting_time ,ending_time ,fri_starting_time,fri_ending_time ,room_no , teacher_name from timetable_intermediate t1 INNER JOIN intermediate_subject t2 on t1.subject_id=t2.subject_id INNER JOIN timetable t3 on t1.id=t3.id WHERE t1.class='FSC pre-engineering' AND t1.part='part-I'";
$result = mysqli_query($con, $sql);
